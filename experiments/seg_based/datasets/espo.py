...
class EspoDataset(Dataset):
    '''
    PyTorch dataset class for the segmentation-based Esposalles dataset
    '''
    ...
    def __init__(self,
        ...
        @param espo_root_dir: full path to the GW root dir
        ...
        # load the dataset
        self.train_list, _, self.test_list = DatasetLoader.load_esposalles(path = espo_root_dir,
                                                                           gt_lower_case=True)
