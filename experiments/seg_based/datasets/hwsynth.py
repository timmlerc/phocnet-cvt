...
class HWSynthDataset(Dataset):
    '''
    PyTorch dataset class for the segmentation-based HW-Synth dataset
    '''
    ...
    def __init__(self,
        ...
        @param hw_root_dir: full path to the HW root dir
        @param split: the type of hw synth split
        ...
        # load the dataset
        self.train_list, self.test_list = DatasetLoader.load_hw_synth_10k(path=hw_root_dir,
                                                                          split=split)
    ...
    def __getitem__(self, index):
        ...
        word_img = self._random_rescale(word_img)
    ...
    def _random_rescale(self, word_img):
